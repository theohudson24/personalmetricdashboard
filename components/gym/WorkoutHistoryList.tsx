    ...
    <Card>
      ...
      <div className="space-y-3">
        {filteredWorkouts.length === 0 ? (
          <EmptyState title={workouts.length ? "No matching workouts" : "Log your first workout"} message={workouts.length ? "Clear or adjust the filters to see more of your history." : "Use the workout logger above, or import your Strong history from Settings."} />
        ) : (
          <>
